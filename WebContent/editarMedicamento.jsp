					...
					<header class="codrops-header">
						...
						<form class="form-horizontal" action="ServletGuardarCambiosMedicamento" method="post">
						  <div class="form-group">
						    ...
						    <div class="col-xs-8">
						      <input id="text1" name="campoNombre" type="text" value="${medicamentoAeditar.nombre}" class="form-control" readonly>
						    </div>
						  </div>
						  <div class="form-group">
						    <label for="text2" class="control-label col-xs-4">Código Nacional</label> 
						    <div class="col-xs-8">
						      <input id="text2" name="campoCodigo" value="${medicamentoAeditar.codigoMedicamento}" type="text" class="form-control" readonly>
						    </div>
						  </div>
						  <div class="form-group">
						    <label for="text3" class="control-label col-xs-4">Precio</label> 
						    <div class="col-xs-8">
						      <input id="text3" name="campoPrecio" value="${medicamentoAeditar.precio}" type="text" class="form-control" readonly>
						    </div>
						  </div>
						  <div class="form-group">
