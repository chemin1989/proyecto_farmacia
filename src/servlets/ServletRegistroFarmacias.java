...
//
//		String gxnombre = "[a-zA-ZáéíóúÁÉÍÓÚÑñ\\s0-9]{3,30}";
//		String gxcontraseña = "((?=.*\\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%]).{6,20})\r\n";
//		String gxdireccion = "[a-zA-ZáéíóúÁÉÍÓÚÑñ\\s0-9]{3,50}";
...
//
//		Pattern p1 = Pattern.compile(gxcontraseña);
...
//		}
		Farmacia f = new Farmacia(nombre, contraseña, direccion, telefono, email, cp, imagen);
